...
export class JoinUsComponent implements OnInit {
  ...
  public onRefresh(item: string): void { // TODO: add void DONE
    if (this.localStorageService.getItem(item) !== null) {
      this.isSubscribed = true; // TODO: You don't need to return value DONE
    }
  }
  ...
  public onValidate(value?: string): void {
    const isValid = this.emailRegExp.test(value || this.inputText); // TODO: empty line after DONE
